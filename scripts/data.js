...
export const ROTEIRO = [
  ...
  },
  {
    ...
    itens: [
      ...
      { hora: "14:45", lugarId: null, titulo: "Direto pro Don Julio", transporte: { tipo: "pe", tempo: "7 min do Vain" }, desc: "Não passa no hotel — vão como estão. Caminhada ou Uber rápido se vier de Recoleta." },
      ...
      { hora: "17:30", lugarId: null, titulo: "Hotel — banho e troca pra noite", transporte: { tipo: "pe", tempo: "7 min do Don Julio" }, desc: "25 min pra trocar e respirar." },
      { hora: "18:00", lugarId: "maria-antonieta", titulo: "🛍️ Maria Antonieta (Bia)", transporte: { tipo: "carro", tempo: "7 min" }, desc: "Uber até Scalabrini Ortiz 265. FECHA 19h — primeira parada por isso. Domingo não abre." },
      { hora: "18:40", lugarId: "vintage-hole", titulo: "🛍️ The Vintage Hole (Bia)", transporte: { tipo: "pe", tempo: "5 min" }, desc: "Caminhada de Maria Antonieta. Vintage de luxo: Chanel, Dior, YSL second-hand. Domingo NÃO abre.", alternativa: "Lourenço: drink no Tres Monos (Guatemala 4699) ou Aldo's Vinoteca enquanto Bia faz o tour" },
      { hora: "19:45", lugarId: null, titulo: "Uber direto pro Florería", transporte: { tipo: "carro", tempo: "15 min" }, desc: "Até Arroyo 872, Retiro. Não passa no hotel." },
  ...
  },
  {
    ...
    itens: [
      ...
      { hora: "11:30", lugarId: null, titulo: "Uber pra Plaza de Mayo", transporte: { tipo: "carro", tempo: "20 min" }, desc: "Do hotel até o Microcentro. Domingo o centro fica vazio, agradável." },
      ...
      { hora: "12:40", lugarId: null, titulo: "Caminhada até San Telmo", transporte: { tipo: "pe", tempo: "15 min" }, desc: "Pela rua Defensa — já vai cruzando o coração do bairro antigo." },
