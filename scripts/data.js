...
export const ROTEIRO = [
  ...
  },
  {
    ...
    itens: [
      ...
      { hora: "12:00", lugarId: "vintage-hole", titulo: "🛍️ The Vintage Hole (Bia)", transporte: { tipo: "pe", tempo: "5 min" }, desc: "Jufré 663, Villa Crespo. Abre 12h. Vintage de luxo: Chanel, Dior, YSL second-hand. Domingo NÃO abre. ~1h na loja." },
      { hora: "13:00", lugarId: null, titulo: "Uber pra Recoleta", transporte: { tipo: "carro", tempo: "10 min" }, desc: "Direto pro Cemitério." },
      { hora: "13:15", lugarId: "recoleta-cemiterio", titulo: "Cemitério da Recoleta", desc: "Túmulo de Evita, mausoléus. ~45 min — versão rápida." },
      { hora: "14:00", lugarId: "el-ateneo", titulo: "El Ateneo Grand Splendid", transporte: { tipo: "pe", tempo: "5 min" }, desc: "Foto rápida da livraria ex-teatro. 15 min.", alternativa: "Maison Mimmi (Parera 46, loja Bia em Recoleta) — passada de 10 min se sobrar tempo" },
      { hora: "14:30", lugarId: null, titulo: "Uber pra Palermo Soho", transporte: { tipo: "carro", tempo: "15 min" }, desc: "Direto pro Don Julio. Não passa no hotel." },
      ...
      { hora: "17:30", lugarId: null, titulo: "Hotel — descanso depois do almoço", transporte: { tipo: "pe", tempo: "7 min do Don Julio" }, desc: "Sem pressa. Cochilo, ler, beber água. Banho fica pra mais tarde." },
      { hora: "19:00", lugarId: null, titulo: "Banho e troca pra noite", desc: "Tem 1h até sair pro Florería." },
      { hora: "20:00", lugarId: null, titulo: "Uber pro Florería", transporte: { tipo: "carro", tempo: "15 min" }, desc: "Até Arroyo 872, Retiro. Chegar 20:15 — abre 20h, evita fila." },
  ...
  },
  {
    ...
    itens: [
      ...
      { hora: "10:45", lugarId: "jardin-botanico", titulo: "🌳 Jardín Botánico", transporte: { tipo: "pe", tempo: "15 min do Cuervo" }, desc: "Passeio leve, ao ar livre. Entrada gratuita. ~30-40 min. Já vai voltando pro hotel pelo caminho." },
      { hora: "11:30", lugarId: null, titulo: "Checkout + luggage storage", transporte: { tipo: "pe", tempo: "10 min do Botânico" }, desc: "Malas ficam no Vain até 17:45." },
      { hora: "11:45", lugarId: null, titulo: "Uber pra Plaza de Mayo", transporte: { tipo: "carro", tempo: "20 min" }, desc: "Do hotel até o Microcentro. Domingo o centro fica vazio." },
      { hora: "12:05", lugarId: "plaza-mayo", titulo: "🏛️ Plaza de Mayo + Casa Rosada", desc: "Foto da Casa Rosada (sede do governo), Catedral, Cabildo. ~30 min." },
      { hora: "12:35", lugarId: null, titulo: "Caminhada até San Telmo", transporte: { tipo: "pe", tempo: "15 min" }, desc: "Pela rua Defensa — coração do bairro antigo." },
      { hora: "12:50", lugarId: "san-telmo", titulo: "Feira de San Telmo 🌟", desc: "Plaza Dorrego. Antiguidades, tango de rua, lojinhas. ~1h10.", alternativa: "Mercat Villa Crespo (mercado gastronômico) se quiserem pular feira" },
